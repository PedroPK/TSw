...
public class ContextoUsuario implements Serializable {
	...
	public short getTpTransacao() {
		if (this.aTpTransacao == 0) {
			// Na serializa��o este atributo vira 0 pois � transient.
			// � preciso redefinir o valor default
	...
	/**
	 * Utilizado nos m�todos alterar e excluir do Cadastro para garantir compara��o correta do timestamp
	 *
	...
	public String getDsTpTransacao() {
		...
		if (this.aTpTransacao == Constantes.TP_TRANSACAO_JTA) {
			...
			dsTpTransacao = "JTA com Conex�o e ResultSet Gerenciados pelo Cliente";
	...
	public void setNmConexaoJNDI(String pNmConexaoJNDI) {
		// Ap�s a primeira RN definir o nome da conex�o JNDI, outra RN n�o pode mais mudar, exceto para null
	...
	public void forcarCdUsuarioJob(String pCdUsuario) throws ExcecaoSistema {
		if (this.isJob()) {
			...
			throw new ExcecaoSistema("S� � permitido for�ar um CdUsuario dentro do ContextoUsuario de Jobs | " + this.toString());
		}
	}
