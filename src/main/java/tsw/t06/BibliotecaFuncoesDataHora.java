...
public final class BibliotecaFuncoesDataHora {
	...
	public static Date getStringComoData(String pData, boolean pInValidarLimitesAno)
		...
		if (pInValidarLimitesAno) {
			if (ano < 1900) {
				throw new ParseException("Ano inv�lido (" + pData + ") - n�o pode ser menor que 1900", posAno);
			}
			
			if (ano > (anoAtual + 100)) {
				throw new ParseException("Ano inv�lido (" + pData + ") - n�o pode ser maior que " + (anoAtual + 100), posAno);
			}
		}
		
		if ( mes < 1 || mes > 12 ) {
			throw new ParseException("M�s inv�lido (" + pData + ") - n�o pode ser menor que 1 nem maior que 12", posMes);
		}
		
		if (dia < 1) {
			throw new ParseException("Dia inv�lido (" + pData + ") - n�o pode ser menor que 1", posDia);
		}
		...
		if ( ( mes == 1 && dia > 31) || (mes == 2 && dia > 29 && calendar.isLeapYear(ano)) //ano bissexto
			...
			throw new ParseException("Dia inv�lido (" + dia + ") para o m�s " + mes, posDia);
		}
	...
	public static Date getStringComoDataHora(String pDataHora)
		...
		if (!isConvertido) {
			throw new ParseException("Data-hora inv�lida (" + pDataHora + ")", 0);
		}

		if (ano < 1900) {
			throw new ParseException("Ano inv�lido (" + pDataHora + ") - n�o pode ser menor que 1900", posAno);
		}

		if (ano > (anoAtual + 100)) {
			throw new ParseException("Ano inv�lido (" + pDataHora + ") - n�o pode ser maior que " + (anoAtual + 100), posAno);
		}

		if ((mes < 1) || (mes > 12)) {
			throw new ParseException("M�s inv�lido (" + pDataHora + ") - n�o pode ser menor que 1 nem maior que 12", posMes);
		}

		if (dia < 1) {
			throw new ParseException("Dia inv�lido (" + pDataHora + ") - n�o pode ser menor que 1", posDia);
		}
	...
	public static String getMesAnterior(String pCdMes)
		...
		if (pCdMes.equals(Constantes.CD_MES_JANEIRO)) {
			...
			throw new ExcecaoParametroInvalido("Codigo de M�s inv�lido (" + pCdMes + ")");
		}
	}
	...
	/**
	 * Retorna o nome do mes por extenso dado sua representa��o n�merica
	 *
	 * @param pNuMes N�mero que representa o mes do ano
	 *
	 * @return
	 *
	 * @exception ExcecaoParametroInvalido Caso n�mero do mes n�o esteja entre os valores 1 e 12
	 */
	...
	public static String getNmMes(int pNuMes) throws ExcecaoParametroInvalido {
		...
		try {
			...
			throw new ExcecaoParametroInvalido("Apenas n�meros positivos entre 1 e 12 correspondem a meses do ano v�lidos");
		}
	...
	/**
	 * Retorna o nome do dia por extenso dado sua representa��o n�merica
	 *
	 * @param pNuDia N�mero que representa o dia da semana
	 *
	 * @return
	 *
	 * @exception ExcecaoParametroInvalido Caso n�mero do dia n�o esteja entre os valores 1 e 7
	 */
	public static String getNmDia(int pNuDia) throws ExcecaoParametroInvalido {
		...
		try {
			...
			throw new ExcecaoParametroInvalido("Apenas n�meros positivos entre 1 e 7 correspondem a dias da semana v�lidos", e);
		}
	...
	/**
	 * Retorna a data de amanh� como java.sql.Date
	 *
	 * @return
	 */
	...
	/**
	 * Retorna a data de amanh� com horas zeradas como java.sql.Date
	 *
	 * @return
	 */
	...
	public static int getQtMeses(Date pData1, Date pData2)
		...
		if (pData1 == null) {
			throw new ExcecaoParametroInvalido("Par�metro Inv�lido! pData1 = null");
		}

		if (pData2 == null) {
			throw new ExcecaoParametroInvalido("Par�metro Inv�lido! pData2 = null");
		}
	 ...
	 * @throws ExcecaoGenerica
	 *
	 * @deprecated Usar os m�todos na FachadaTGE.
	 */
	...
	/**
	 * Integra��o com TGE n�o dispon�vel
	 *
	 * @param pDataInicial
	 * @param pDataFinal
	 *
	 ...
	 *
	 * @param pDtMes N�mero inteiro relativo ao m�s: 1-Janeiro, 2-Fevereiro, etc...
	 *
	 * @return Constante que representa a chave do m�s: Constantes.CD_MES_JANEIRO, Constantes.CD_MES_FEVEREIRO, etc...
	 */
	 ...
	 * Utilizado dentro da JSP
	 *
	 * @param pCdMes Constante que representa a chave do m�s: Constantes.CD_MES_JANEIRO, Constantes.CD_MES_FEVEREIRO, etc...
	 *
	 * @return N�mero inteiro relativo ao m�s: 1-Janeiro, 2-Fevereiro, etc...
	 */
