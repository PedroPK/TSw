...
public class Ordenador {
	...
	/**
	 * Método que deverá obter uma Lista com o Menor e com o Maior valores.
	 * 
	 * O item colocado na Posição 0 será o Menor
	 * O item colocado na Posição 1 será o Maior 
	 * 
	 * @param pColecao
	 * @return
	 * @throws ColecaoNulaException
